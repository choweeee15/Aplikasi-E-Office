...
<head>
  ...
  <!-- Favicons -->
  <link href="<?=base_url('foto1kelas/logoogph_1_-removebg-preview.png')?>" rel="icon">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="<?=base_url('foto1kelas/logoogph_1_-removebg-preview.png')?>
        " alt="">
        <span class="d-none d-lg-block">E-Office</span>
      </a>
