      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?= base_url('home/simpansuratkeluar'); ?>" method="post" enctype="multipart/form-data">
              <div class="row mb-3">
                <label for="pengirim" class="col-sm-4 col-form-label">Pengirim:</label>
                <div class="col-sm-8">
                  <input type="text" name="pengirim" id="pengirim" class="form-control" value="<?= session()->get('nama'); ?>" required>
                </div>
              </div>
              <div class="row mb-3">
