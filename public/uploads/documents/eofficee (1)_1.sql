...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2024 at 03:31 AM
...
(3235, 'Dokumen Umum Sekolah', '4', 2),
(3236, 'Dokumen Akademik', '2', 7),
(3237, 'Dokumen Keuangan', '5', 1),
(3238, 'Dokumen Kepegawaian', '6', 0),
(3239, 'Dokumen Kesiswaan', '8', 9);
...
--
DELIMITER $$
CREATE TRIGGER `dwa` AFTER DELETE ON `surat_keluar` FOR EACH ROW UPDATE barang
...
--
ALTER TABLE `surat`
  MODIFY `id_surat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3240;
...
--
ALTER TABLE `user`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3270;
